...
validate-local : check-mimetypes.py.out check-mimetypes-perl.sh.out readme.html todo.html coverage_report.txt
...
check-mimetypes-perl.sh.out : check-mimetypes-perl.sh media-types/*/* Makefile
	bash check-mimetypes-perl.sh media-types/ > check-mimetypes-perl.sh.out
...
clean:
	...
	rm --force check-mimetypes-perl.sh.out
